...
.. list-table::
   ...
   * - :ref:`NITF <raster.nitf>`
     ...
     - **Yes**
     - Built-in by default
   * - :ref:`NOAA_B <raster.noaa_b>`
     - NOAA GEOCON/NADCON5 .b format
     - No
     - No
     - **Yes**
     - Built-in by default
   * - :ref:`NSIDCbin <raster.nsidcbin>`
   ...
   * - :ref:`OGCAPI <raster.ogcapi>`
     ...
     - **Yes**
     - libcurl
   * - :ref:`OpenFileGDB <raster.openfilegdb>`
